...
positive_vocab = open(os.path.join(os.path.dirname(__file__), 'positive_words.txt'))
negative_vocab = open(os.path.join(os.path.dirname(__file__),'negative_words.txt'))
neutral_vocab = [ 'movie','the','sound','was','is','actors','did','words' ]
